...
<template>
    <el-container class="main-container">
        <el-header><NavMenu class="hidden-md-and-up top-menu" mode="horizontal"></NavMenu><el-link type="success" @click="onLogout()"><el-icon><Position></Position></el-icon>退出</el-link></el-header>
        <el-container>
